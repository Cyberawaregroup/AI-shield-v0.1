...
from app.models.chatbot import (
    ...
    ChatMessageCreate, ChatMessageResponse, FraudReport, FraudReportCreate,
    FraudReportResponse
)
...
async def escalate_chat_session(
    ...
    try:
        ...
        return {"message": "Session escalated successfully", "advisor_id": escalation_result.get("advisor_id")}
    except Exception as e:
